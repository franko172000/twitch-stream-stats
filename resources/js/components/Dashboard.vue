            ...
            <main class="flex-1 pb-8">
                ...
                <div class="mt-8">
                                ...
                                <div class="p-5">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <component class="h-6 w-6 text-gray-400" aria-hidden="true" />
                                        </div>
                    ...
                    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 gap-4">
                        ...
                        <div class="w-full">
                            <h2 class="max-w-6xl mx-auto mt-8 text-lg leading-6 font-medium text-gray-900">Top Streams per Game</h2>
...
const cards = ref([
    { name: 'Total Streams', href: '#', icon: ScaleIcon, amount: '$30,659.45' },
    { name: 'Total Games', href: '#', icon: ScaleIcon, amount: '$30,659.45' },
    { name: 'Median number of viewers', href: '#', icon: ScaleIcon, amount: '$30,659.45' },
    // More items...
]);
